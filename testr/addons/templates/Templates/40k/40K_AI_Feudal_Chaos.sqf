...
_loadoutData set ["longRangeRadios", ["ic_ChaosArmour_Cad"]];
...
_loadoutData set ["sniHats", ["ic_ChaosHelmV3"]];
...
_militaryLoadoutData set ["backpacks", ["ic_feudalBackpack", "ic_elysianBackpack"]];
