...
["vehiclesAPCs", ["IC_Chimera_01_SoS", "IC_Chimerro_01_SoS"]] call _fnc_saveToTemplate; 				//this line determines APCs -- Example: ["vehiclesAPCs", ["B_APC_Tracked_01_rcws_F", "B_APC_Tracked_01_CRV_F"]] -- Array, can contain multiple assets
...
["vehiclesPlanesCAS", ["Valkyrie_Possessed_B_O"]] call _fnc_saveToTemplate; 		//this line determines CAS planes -- Example: ["vehiclesPlanesCAS", ["B_Plane_CAS_01_dynamicLoadout_F"]] -- Array, can contain multiple assets
...
["vehiclesHelisLight", ["Valkyrie_Possessed_B_O"]] call _fnc_saveToTemplate; 		//this line determines light helis -- Example: ["vehiclesHelisLight", ["B_Heli_Light_01_F"]] -- Array, can contain multiple assets
["vehiclesHelisTransport", ["Valkyrie_Possessed_B_O"]] call _fnc_saveToTemplate; 	//this line determines transport helis -- Example: ["vehiclesHelisTransport", ["B_Heli_Transport_01_F"]] -- Array, can contain multiple assets
...
["staticMGs", ["TIOW_IG_HeavyBolter_RenBrown_OP"]] call _fnc_saveToTemplate; 					//this line determines static MGs -- Example: ["staticMG", ["B_HMG_01_high_F"]] -- Array, can contain multiple assets
["staticAT", ["TIOW_IG_MissileLauncher_AT_RenBrown_OP"]] call _fnc_saveToTemplate; 					//this line determinesstatic ATs -- Example: ["staticAT", ["B_static_AT_F"]] -- Array, can contain multiple assets
["staticAA", ["TIOW_IG_MissileLauncher_AA_RenBrown_OP"]] call _fnc_saveToTemplate; 					//this line determines static AAs -- Example: ["staticAA", ["B_static_AA_F"]] -- Array, can contain multiple assets
["staticMortars", ["TIOW_IG_Mortar_RenBrown_OP"]] call _fnc_saveToTemplate; 				//this line determines static mortars -- Example: ["staticMortars", ["B_Mortar_01_F"]] -- Array, can contain multiple assets
...
_sfLoadoutData set ["uniforms", ["TIOW_Mk4PowerArmor_1_NL"]];
_sfLoadoutData set ["vests", ["TIOW_ChaosLimbs_NL"]];
_sfLoadoutData set ["Hvests", ["TIOW_ChaosLimbs_NL"]];
_sfLoadoutData set ["backpacks", ["TIOW_Chaos2Powerpack_NL"]];
_sfLoadoutData set ["helmets", ["TIOW_Mk4Helmet_NL"]];
...
_eliteLoadoutData set ["uniforms", ["IC_U_Moebian_31st_B"]];
_eliteLoadoutData set ["slUniforms", ["IC_U_Moebian_31st_B"]];
_eliteLoadoutData set ["vests", ["ic_Moebian_Vest6thHaz"]];
_eliteLoadoutData set ["Hvests", ["ic_Moebian_Vest6th"]];
_eliteLoadoutData set ["backpacks", ["ic_ChaosBackPack"]];
_eliteLoadoutData set ["helmets", ["ic_moebian3Helm6th","ic_moebian2Helm6th"]];
_eliteLoadoutData set ["binoculars", ["ic_cad_magnoculars"]];

_eliteLoadoutData set ["slRifles", [
["dm_M36ModularV1", "dm_M36HoloSight", "", "IC_bayonet_02", ["ic_las_powerpack"], [], ""]
]];
...
_militaryLoadoutData set ["uniforms", ["IC_U_Moebian_31st_B"]];
_militaryLoadoutData set ["slUniforms", ["IC_U_Moebian_31st_B"]];
_militaryLoadoutData set ["vests", ["ic_Moebian_Vest6th2","ic_Moebian_Vest6th"]];
_militaryLoadoutData set ["Hvests", ["ic_Moebian_Vest6th3"]];
_militaryLoadoutData set ["backpacks", ["ic_ChaosBackPack"]];
_militaryLoadoutData set ["helmets", ["ic_ChaosHelmV1","ic_ChaosHelmV2","ic_ChaosHelmV3"]];
...
["dm_M36ModularV3", "dm_M36HoloSight", "", "IC_bayonet_02", ["ic_las_powerpack"], [], ""]
]];
...
["ic_cad_LuciusLMG", "", "", "IC_bayonet_02", ["ic_las_LMGpowerpack"], [], ""]
]];
_militaryLoadoutData set ["marksmanRifles", [
["ic_cad_LuciusFMPoly", "dm_M362xSightNM", "", "IC_bayonet_02", ["ic_las_powerpack"], [], ""]
]];
_militaryLoadoutData set ["sniperRifles", [
["dm_M36ModularV4", "dm_M3610xSight", "", "IC_bayonet_02", ["IC_LuciusLongLas_powerpack"], [], ""]
]];
...
_policeLoadoutData set ["uniforms", ["IC_ChaosRenegade_U_V2Red_B"]];
_policeLoadoutData set ["vests", ["ic_feudalArmour_Chaos"]];
_policeLoadoutData set ["helmets", ["ic_feudalHelmChaosOpen","ic_feudalHelmChaos"]];
...
_militiaLoadoutData set ["uniforms", ["IC_ChaosRenegade_U_V2Red_B"]];
_militiaLoadoutData set ["vests", ["ic_ChaosArmour_Vest1"]];
_militiaLoadoutData set ["Hvests", ["ic_Bloodpact_Vest2"]];
_militiaLoadoutData set ["backpacks", ["ic_ChaosBackPack"]];
_militiaLoadoutData set ["helmets", ["ic_ChaosHelmV1","ic_ChaosHelmV2","ic_ChaosHelmV3"]];


_militiaLoadoutData set ["slRifles", [
["ic_cad_m36_lasgunRenegade", "", "", "IC_bayonet_02", ["ic_las_powerpackGreen"], [], ""]
]];
_militiaLoadoutData set ["rifles", [
["ic_cad_m36_lasgunRenegade", "", "", "IC_bayonet_02", ["ic_las_powerpackGreen"], [], ""]
]];
_militiaLoadoutData set ["carbines", [
["ICP_Rifle_Voss_sos", "", "", "", ["ic_las_powerpack"], [], ""]
]];
