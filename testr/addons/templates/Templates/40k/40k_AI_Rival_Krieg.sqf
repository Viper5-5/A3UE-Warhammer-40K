...
["nameLeader", "Amim Kagori"] call _fnc_saveToTemplate;

//////////////////////////////////////
//       	Identities    			//
//////////////////////////////////////
["faces", ["PersianHead_A3_01"]] call _fnc_saveToTemplate; 
...
["staticAT", ["TIOW_IG_MissileLauncher_AT_1490_Blu"]] call _fnc_saveToTemplate;
["staticMortars", ["TIOW_IG_Mortar_1490_Blu"]] call _fnc_saveToTemplate;
...
private _rifles = [
	["ic_cad_LuciusP", "", "", "IC_bayonet_01", ["ic_las_powerpack"], [], ""]
];
...
private _pistols = ["Shovel_Russian"];
...
_loadoutData set ["offuniforms", ["U_TIOW_Comissar_Krieg"]];
_loadoutData set ["vests", ["dm_CadianArmour", "dm_CadianArmour4", "dm_CadianArmour5Light", "dm_CadianArmour6Light"]];
_loadoutData set ["heavyVests", ["dm_CadianArmour2","dm_CadianArmour3","dm_CadianArmour5","dm_CadianArmour6"]];
_loadoutData set ["backpacks", ["DKoK_BackPack", "DKoK_Eng_BackPack","ic_feudalBackpack","ic_elysianBackpack"]];
_loadoutData set ["helmets", ["DKoK_GM_Helm_1490th"]];
_loadoutData set ["crewHelmets", ["DKoK_GM_Helm_1490th"]];
...
_crewLoadoutData set ["vests", ["dm_CadianArmour"]];
_crewLoadoutData set ["helmets", ["DKoK_GM_Helm_1490th"]];

private _pilotLoadoutData = _loadoutData call _fnc_copyLoadoutData;
_pilotLoadoutData set ["vests", ["dm_CadianArmour"]];
_pilotLoadoutData set ["helmets", ["DKoK_GM_Helm_1490th"]];
