...
["name", "Imperial Guard"] call _fnc_saveToTemplate;
...
["staticMGs", ["FIG_HeavyBolterChaosRen"]] call _fnc_saveToTemplate;
...
"FIG_M36Kantrael","FIG_CombatShotgun","FIG_PlasmaGun","FIG_Laspistol",
"FIG_LasGun_Standart","FIG_6Rnd_ShotgunMag","FIG_6Rnd_ShotgunMagSlug","Fig_PlasmaMag","FIG_LasPistol_Standart",
"FIG_CadianWebbingBP","FIG_CadianBackpack1",
"FIG_CadianArmourPV1","FIG_CadianArmour","FIG_CadianArmourPV2","FIG_CadianArmourPV3","FIG_CadianArmourPV4",
"FIG_CadianArmourNS","FIG_CadianArmourNSPV2","FIG_CadianArmourNSPV3","FIG_CadianArmourNSPV4",
"FIG_CadianHelm","FIG_CadianHelmGD","FIG_CadianHelmGU","FIG_CadianCap",
"Binocular","acc_flashlight", "Laserbatteries","acc_flashlight_smg_01","acc_flashlight_pistol","FIG_M36Bayonet"];


if (["WBK_WarhammerMeleeStuff"] call A3U_fnc_hasAddon) then {
    _initialRebelEquipment append ["FIG_Knife","FIG_KnifeRotated","WBK_ww1_Club"];
};
...
private _rebUniforms = ["FIG_CadianUniformV1_U_B","FIG_CadianUniformV4_U_B","FIG_CadianUniformV4_1_U_B","FIG_CadianUniformV2_U_B","FIG_CadianUniformV3_U_B","FIG_CadianUniformV5_U_B"];          //Uniforms given to Normal Rebels
...
["headgear", ["FIG_CadianHelm","FIG_CadianHelmGD","FIG_CadianHelmGU","FIG_CadianCap"]] call _fnc_saveToTemplate;          //Headgear used by Rebell Ai until you have Armored Headgear.
...
["faces", ["GreekHead_A3_02","GreekHead_A3_03","GreekHead_A3_04","GreekHead_A3_05","GreekHead_A3_06","GreekHead_A3_07","GreekHead_A3_08","GreekHead_A3_09","GreekHead_A3_10","GreekHead_A3_11","GreekHead_A3_12","GreekHead_A3_13","GreekHead_A3_14","Ioannou","Mavros","Sturrock"]] call _fnc_saveToTemplate;
...
_loadoutData set ["facewear", ["FIG_CadianGlovesFW","FIG_CadianHeadsetGrey","FIG_CadianWebbing"]];
