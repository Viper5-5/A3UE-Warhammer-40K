...
["name", "Death Korps of Krieg"] call _fnc_saveToTemplate;
...
"FIG_Lucius_Lasgun","FIG_KriegShotgun","FIG_PlasmaGun","FIG_Laspistol",
"FIG_LasGun_Standart","FIG_8Rnd_ShotgunMag","FIG_8Rnd_ShotgunMagSlug","Fig_PlasmaMag","FIG_LasPistol_Standart",
"FIG_KriegBackpack1",
"FIG_KriegGrenVestV1","FIG_KriegVestV1","FIG_KriegVestV2","FIG_KriegVestV1_Med","FIG_KriegVestV2_Med",
"FIG_KriegHelmet","FIG_KriegHelmet_Med1", "FIG_KriegHelmet_Med2",
...
if (["WBK_WarhammerMeleeStuff"] call A3U_fnc_hasAddon) then {
    _initialRebelEquipment append ["FIG_KriegMace","FIG_Knife","FIG_KnifeRotated","WBK_ww1_Club"];
};
...
private _rebUniforms = ["FIG_KriegUniformV1_U_B","FIG_KriegUniformV2_U_B"];          //Uniforms given to Normal Rebels
...
["headgear", ["FIG_KriegHelmet","FIG_KriegHelmet_Med1", "FIG_KriegHelmet_Med2"]] call _fnc_saveToTemplate;          //Headgear used by Rebell Ai until you have Armored Headgear.
