...
["name", "Sons of Sek"] call _fnc_saveToTemplate;
...
"FIG_M36KantraelChaos","FIG_CombatShotgunChaos","FIG_PlasmaGunChaos","FIG_Laspistol",
"FIG_LasGun_Standart","FIG_6Rnd_ShotgunMag","FIG_6Rnd_ShotgunMagSlug","Fig_PlasmaMag","FIG_LasPistol_Standart",
"ic_ChaosBackPack",
"IC_Chaos_Armor_01",
"IC_SOS_helmet_01","IC_SOS_helmet_02", "IC_SOS_helmet_02_grey", "IC_SOS_helmet_03",
...
if (["WBK_WarhammerMeleeStuff"] call A3U_fnc_hasAddon) then {
    _initialRebelEquipment append ["WBK_ChaosKnife","Bat_Spike","WBK_ww1_Club"];
};
...
private _rebUniforms = ["IC_sos_U_rifleman_01_O","IC_sos_U_rifleman_02_O","IC_sos_U_rifleman_03_O","IC_sos_U_rifleman_04_O"];          //Uniforms given to Normal Rebels
...
["headgear", ["IC_SOS_helmet_02_grey","IC_SOS_helmet_02","IC_SOS_helmet_01","IC_SOS_helmet_03"]] call _fnc_saveToTemplate;          //Headgear used by Rebell Ai until you have Armored Headgear.
...
["faces", ["IC_ChaosHead_01"]] call _fnc_saveToTemplate;
...
_loadoutData set ["facewear", ["IC_sos_mask_01","IC_Chaos_mask_02","IC_Chaos_mask_03"]];
